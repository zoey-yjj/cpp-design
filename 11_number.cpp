 ...
 * Iterator pattern
 *
 * 1. Iterate through different data structures.
 * 2. Iterate interface to iterate through any collection without
 *    knowing its internal structure.
 * 3. Iterators keep track of their current position in the 
 *    collection, so that can have multiple iterators iterating through
