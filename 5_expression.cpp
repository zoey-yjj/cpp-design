 ...
 * Interpreter pattern
 *
 * 1. Interface with some language outside its normal comprehension.
 * 2. Recursive grammer to convert language does not understand into
 *    some form it does understand.
 */
...
public:
    OperationExpression(const std::string &operatorSymbol, Expression *lhs, Expression *rhs) : 
